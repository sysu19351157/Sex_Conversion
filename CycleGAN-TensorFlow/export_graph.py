...
tf.flags.DEFINE_string('checkpoint_dir', '../checkpoints/20210624-0231/', 'checkpoints directory path')
tf.flags.DEFINE_string('XtoY_model', 'male2female.pb', 'XtoY model name, default: apple2orange.pb')
tf.flags.DEFINE_string('YtoX_model', 'female2male.pb', 'YtoX model name, default: orange2apple.pb')
