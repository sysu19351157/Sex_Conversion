...
tf.flags.DEFINE_string('X_input_dir', '../data/male/',
                       'X input directory, default: ../data/male/')
tf.flags.DEFINE_string('Y_input_dir', '../data/female',
                       'Y input directory, default: ../data/female/')
tf.flags.DEFINE_string('X_output_file', '../data/male.tfrecords',
                       'X output tfrecords file, default: ../data/male.tfrecords')
tf.flags.DEFINE_string('Y_output_file', '../data/female.tfrecords',
                       'Y output tfrecords file, default: ../data/female.tfrecords')
