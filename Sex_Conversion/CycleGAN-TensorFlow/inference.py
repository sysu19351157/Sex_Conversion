...
tf.flags.DEFINE_string('model', '../pretrained/male2female.pb', 'model path (.pb)')
tf.flags.DEFINE_string('input', '../Trump.jpg', 'input image path (.jpg)')
tf.flags.DEFINE_string('output', '../trump_female.jpg', 'output image path (.jpg)')
